...
import * as QuizzActions from './quizz.action';
...
describe('quizzReducer', () => {
  ...
  describe('getQuizzesSuccessAction', () => {
    ...
    const action = QuizzActions.getQuizzesSuccessAction({
      quizzes: quizzesFromEffects,
    });
  ...
  describe('getQuizzesFailureAction', () => {
    const action = QuizzActions.getQuizzesFailureAction({
