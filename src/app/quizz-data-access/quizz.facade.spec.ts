...
describe('QuizzFacade', () => {
  ...
  it('should be loaded', (done) => {
    const loaded$ = facade.getQuizzes$().pipe(switchMap(() => facade.loaded$));
  ...
  it('should have quizzes', (done) => {
    const quizzes$ = facade
      .getQuizzes$()
      .pipe(switchMap(() => facade.quizzes$));
  ...
  it('should not have error', (done) => {
    const error$ = facade.getQuizzes$().pipe(switchMap(() => facade.error$));
